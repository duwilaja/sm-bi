...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Indeks Ketertiban&nbsp;<span style="font-weight:bold;" class="loc"></span></div>
            <div class="card-body">
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Indeks kepatuhan kelompok usia terhadap tata tertib berlalu lintas&nbsp;<span style="font-weight:bold;" class="loc"></span></div>
            <div class="card-body">
